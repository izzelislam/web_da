...
final class SchoolYearTable extends PowerGridComponent
{
    use ActionButton;
    ...
    *
    * @return Builder<\App\Models\SchoolYear>
    */
...
;
    ...
    */
     ...
     /**
     * PowerGrid SchoolYear Action Buttons.
     *
    ...
    */
     ...
     /**
     * PowerGrid SchoolYear Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($school-year) => $school-year->id === 1)
                ->hide(),
        ];
    }
    */
